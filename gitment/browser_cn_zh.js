...
var NOT_INITIALIZED_ERROR = exports.NOT_INITIALIZED_ERROR = new Error('评论还未初始化');
...
function renderEditor(_ref3, instance) {
  ...
  previewTab.onclick = function () {
    ...
    if (!content) {
      preview.innerText = '什么也没有';
      return;
    }

    preview.innerText = '生成预览...';
